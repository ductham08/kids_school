...
INSERT INTO `shiftClass` VALUES (2, '10:30:00', '12:00:00', '2');
INSERT INTO `shiftClass` VALUES (3, '13:25:00', '15:25:00', '3');
...
-- Records of students
-- ----------------------------
INSERT INTO `students` VALUES (5, '2022-02-15', ' Trần Minh Anh', '0123456789', '0123456789', 26, 'HS87037', 1, 'Trần Văn An', 'Nguyễn Thị Minh An', 0);
...
-- Records of teachers
-- ----------------------------
INSERT INTO `teachers` VALUES (1, 'Minh Anh', 'Admin@gmail.com', '26', '1', NULL, NULL, '26', '2');
...
CREATE TABLE `user`  (
  ...
  `user_address` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `role` int NOT NULL,
