<?php
	...
	if (isset($_POST["btnSubmit"])) {
		...
		$sqlCreateBlog = "INSERT INTO `blog`(`title`, `content`, `thumnail`, `publics`, `createAt`, `sort_content`) VALUES ('$title','$content','$path','$is_public',now(), '$desc_content')";
    ...
    <div class="add col-12">
        <div class="form col-12">
            <form method="POST" enctype="multipart/form-data">
                ...
                <div class="itemForm col-7">
                    <p>Mô tả ngắn:</p>
                    <textarea required name="desc_content" rows="5"></textarea>
                </div>
                <div class="itemForm">
